        ...
        for customer in customers:
            ...
            if customer['id'] not in customers_with_recommendation:
                ...
                if len(reachable_stations) != 0:
                    ...
                    recommendations.append(create_recommendation(station_choice['inNode'], customer['id'], 1))
                    ...
                    station_choice = reachable_dumb_stations[tuple(reachable_dumb_stations.keys())[0]]
